...
con=sqlcon.connect(host="localhost",user="root",password="CODE1234")#connection to mysql 
cur=con.cursor()
...
def lst_doc():
    ...
    l=["Dr. Purohit","Dr. Yadav","Dr. Kumar","Dr. Yogi","Dr. Kohli","Dr. singh","Dr. Sidharth","Dr. Yaduvanshi","Dr. Virat","Dr. Anuj",'Dr. Irfan','Dr. Modi',
       'Dr. Sanjay','Dr. Rajeev']
...
label=Label(root,text="BHARATIYA HOSPITAL \n भारतीय चिकित्सालय",font="arial 40 bold",bg='black')
b1=Button(text="Registration \n पंजीकरण",font="arial 20 bold",bg='yellow',command=register)
b2=Button(text="Appointment \n प्रस्तावित भेंट",font="arial 20 bold",bg='yellow',command=apoint)
b3=Button(text="List of Doctors \n चिकित्सक सूची",font="arial 20 bold",bg='yellow',command=lst_doc)
b4=Button(text="Services available \n उपलब्ध सेवाएँ",font='arial 20 bold',bg='yellow',command=ser_avail)
b7=Button(text="View data \n डेटा देखें",font='arial 20 bold',bg='yellow',command=search_data)
b5=Button(text="Modify existing data \n मौजूदा डेटा को संशोधित करें",font='arial 20 bold',bg='yellow',command=mod_sub)
b6=Button(text="Exit \n निकास",font='arial 20 bold',command=root.destroy,fg="red")
label.pack()
